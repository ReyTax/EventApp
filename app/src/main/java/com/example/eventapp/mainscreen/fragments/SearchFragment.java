...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        colRefAll = firebaseFirestore.collection("announcements");
        return view;
    }
    ...
    private void readData(final FirestoreCallback firestoreCallback){
        firebaseFirestore.collection("announcements").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
        @Override
